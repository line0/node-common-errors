const STATUS_CODES = require('./data/status-codes');
const captureStackTrace = require('./helpers/capture-stack-trace');

const STATUS_CODE_ATTRIBUTE_NAME = module.exports.STATUS_CODE_ATTRIBUTE_NAME = 'status';
...
function HttpStatusError(status_code, message) {
  ...
  if(!this.stack) captureStackTrace(this, HttpStatusError);
